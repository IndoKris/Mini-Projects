...
-------------------------------------------------------------------------------------------------
    ...
    | Mode   | Description                                      |
    |--------|--------------------------------------------------|
    | Easy   | Arrange 'Your Symbol' in order to win.                    |
    | Medium | If no one wins, you win.                        |
    | Hard   | If the computer wins, you win.                  |

-------------------------------------------------------------------------------------------------
    '''
print(rule)
player =input('Enter Your Symbol: ')
p = player[0]                                # Takes Symbols of Player and Computer from User
comp = input("Select Computer's Symbol:")
c = comp[0]
...
3 - Hard
-------------------------------------------------------------------------------------------------
Enter your choice: """) #Decides Level of game

while mode not in ['1','2','3'] :
    print("""
-------------------------------------------------------------------------------------------------
    Invalid Mode! Please select a correct mode (1, 2, or 3).
-------------------------------------------------------------------------------------------------
    """)
    mode = input('''
Select Mode: 
